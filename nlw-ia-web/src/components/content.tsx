    ...
    <main className="flex flex-1 py-6 gap-6">
      <div className="flex flex-col flex-1 gap-4">
        <div className="grid grid-rows-2 gap-4 flex-1">
          ...
          <Textarea placeholder="Resultado gerado pela IA..." className="resize-none p-4 leading-relaxed" readOnly value={completion} />
        </div>
      ...
      <aside className="w-80 space-y-6">
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <Button type="submit" disabled={isLoading} className="w-full text-white bg-cyan-500 hover:bg-cyan-700">
            Executar
